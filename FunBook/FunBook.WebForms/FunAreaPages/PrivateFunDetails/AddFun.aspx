...
<asp:Content ContentPlaceHolderID="ContentPlaceHolderFunArea" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanelFunForms" runat="server">
                ...
                <form name="picture-form" class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <a href="/" class="btn btn-default" runat="server">Cancel</a>
                                <asp:LinkButton ID="FileUploadClicker" Text="Create" runat="server" class="btn btn-primary" OnClick="PictureSubmit_Click" />
                            </div>
                        </div>
                    </fieldset>
                </form>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="FileUploadClicker" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
